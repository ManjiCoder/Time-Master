...
export default function Setting() {
  ...
  return (
    <main
      className={`bg-slate-300 dark:bg-slate-800 dark:text-white text-slate-800 min-h-screen pb-10 ${inter.className} py-4`}
    >
      <h2 className="text-2xl font-semibold px-4">Settings</h2>
      <ol className="flex flex-col mt-4 text-lg">
        <li className="bg-slate-200 dark:bg-slate-700 shadow-md rounded-md py-4 px-4 border border-slate-400">
          <Link href={'/'}>Home</Link>
        </li>
        <li className="bg-slate-200 dark:bg-slate-700 shadow-md rounded-md py-4 px-4 border border-slate-400">
        ...
        <li className="bg-slate-200 dark:bg-slate-700 shadow-md rounded-md py-4 px-4 border border-slate-400 flex space-x-2 items-center justify-start">
          Salary Amount :
